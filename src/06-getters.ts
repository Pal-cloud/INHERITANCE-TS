export class MyDate {
    ...
    printFormat(): string {
        const day = this.addPadding(this._day); //un método puede acceder a otro método de la misma clase
   ...
   private addPadding(value: number) {
    ...
    //con el get delante se comporta como una propiedad más
    ...
    // get myReturn(): void => no se puede hacer porque siempre debe retornar algo
}
